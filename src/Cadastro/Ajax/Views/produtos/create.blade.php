    <section class="content-header">
        <h1>
            <span id="div-titulo-pagina">Adicionar Produto</span>
        </h1>
    </section>            
            ...
            <div class="col-xs-12">
                <div class="box box-success" id="div-box">
                    ...
                    <div class="box-footer align-right">
                        ...
                        <button  style="margin-left: 5px;" class="btn btn-success" onclick="modelStore( '{{ route('produtos.ajax.store') }}')" ><i class="fa fa-check"></i> Salvar</button> 
                    </div>
