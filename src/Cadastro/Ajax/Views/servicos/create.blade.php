        ...
        <div class="col-xs-12">
            <div class="box box-success" id="div-box">
                ...
                <div class="box-footer align-right">
                    ...
                    <button  style="margin-left: 5px;" class="btn btn-success" onclick="modelStore( '{{ route('servicos.ajax.store') }}' , null , function(){comboboxFunction();} )" ><i class="fa fa-check"></i> Salvar</button> 
                </div>
